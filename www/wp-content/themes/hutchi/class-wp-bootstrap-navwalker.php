		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				if ( $container ) {
					...
					if ( $container_id ) {
						$fallback_output .= ' id="XXX' . esc_attr( $container_id ) . '"';
					}
					if ( $container_class ) {
				...
				//theme-specific modification!
				$fallback_output .= '<div class="border-frame"><div class="top-left"></div><div class="top-right"></div>';
